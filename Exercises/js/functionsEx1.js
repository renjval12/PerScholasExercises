...
// var num1 = Number(prompt('Type in a number: '))
// var num2 = Number(prompt('Type in a number to add to your first number: '))
...
// console.log("Method 1 (addMethod1()): " + addMethod1())
// console.log("Method 2 (addMethod2(a, b)): " + addMethod2(num1, num2))
